...
export default function Typewriter() {
  ...
  `}
          ...
          <div className="animate-typing  py-2 bg-card rounded-md flex justify-between select-none">
            ...
            <svg onClick={() => setAnimKey((p) => p + 1)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mr-2 cursor-pointer hover:fill-green-900">
